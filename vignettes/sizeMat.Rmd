...
## Plot maturity ogive
For plotting the maturity ogive, an object of class "morphMat"is required. The function `plot` generates 4 graphics: 1), 2) and 3) are histograms for the A, B parameters and the size at morphometric maturity (L50), the last is the maturity ogive.
...
## Plot maturity ogive
For plotting the maturity ogive the object of class "gonadMat"is required. The function `plot` generates 4 graphics: 1), 2) and 3) are histograms for the A, B parameters and the size at morphometric maturity (L50), the last is the maturity ogive.
