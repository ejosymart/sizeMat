# ssmRG package: Size at Sexual Maturity ---------------
...
#'
#' @description Package to estimate morphometric (based on relative growth) and gonadal size at sexual maturity, for organisms, usually fish and invertebrates.
#' @name ssmRG-package
